            ...
            {!submitted ? (
              <>
                <Field label="Business Name">
                  <input required placeholder="Your Business, LLC" className="field-input" />
                </Field>
                <Field label="Industry">
                  <input required placeholder="e.g. real estate, wellness, home services" className="field-input" />
                </Field>
                <Field label="Preferred Plan">
                  <select defaultValue="Automated" className="field-input">
                ...
                <div className="grid grid-cols-2 gap-3.5">
                  <Field label="Approx. list size">
                    <input type="number" min={1} placeholder="500" className="field-input" />
                  </Field>
                  <Field label="Email">
                    <input type="email" required placeholder="you@business.com" className="field-input" />
                  </Field>
                </div>
                <button
                  type="submit"
