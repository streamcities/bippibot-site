...
export default function RealEstateVideoClient() {
              ...
              try {
                const res = await fetch("/api/submit-lead", {
                  ...
                  body: JSON.stringify({
                    ...
                    source: "Real Estate Video Landing Page",
                    custom_fields: {
                      property_address: data.get("propertyAddress"),
                      mls_url: data.get("mlsUrl"),
            ...
            {!submitted ? (
              <>
                <Field label="Agent Name">
                  <input name="agentName" required placeholder="Jane Smith" className="field-input" />
                </Field>
                <Field label="Property Address">
                  <input name="propertyAddress" required placeholder="123 Maple Street, Springfield, USA" className="field-input" />
                </Field>
                <Field label="MLS Listing URL">
                  <input name="mlsUrl" type="url" placeholder="https://www.mlslisting.com/..." className="field-input" />
                </Field>
                <div className="grid grid-cols-2 gap-3.5">
                  <Field label="Number of Photos">
                    <input name="numPhotos" type="number" min={1} required placeholder="24" className="field-input" />
                  </Field>
                  <Field label="Email">
                    <input name="email" type="email" required placeholder="you@brokerage.com" className="field-input" />
                  </Field>
                </div>
